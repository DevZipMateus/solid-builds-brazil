  ...
  return (
    <section id="sobre" className="section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
          ...
          <ScrollReveal animation="fade-left" delay={200}>
            <div className="relative">
              ...
              <img 
                ...
                className="relative w-full h-auto rounded-2xl shadow-solid-lg object-cover hover-lift"
              />
            </div>
          </ScrollReveal>
        </div>
        ...
        {/* Market */}
        <div className="grid lg:grid-cols-2 gap-12 mb-20 items-center">
          <ScrollReveal animation="fade-up" className="lg:order-2">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-primary/20 to-primary/5 rounded-2xl blur-xl" />
              <div className="relative bg-secondary/50 rounded-2xl p-8 border border-border hover-glow">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <ScrollReveal animation="fade-up" delay={0}>
            <div className="card-elevated p-8 text-center group hover:border-primary/50 transition-all duration-300 hover-lift h-full">
