  ...
  return (
    <section id="servicos" className="section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
          ...
          {services.map((service, index) => {
            ...
            return (
              <ScrollReveal key={index} animation="scale" delay={index * 100}>
                <div className="group bg-background rounded-2xl p-8 border border-border hover:border-primary/50 transition-all duration-300 hover-lift h-full">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          <ScrollReveal animation="fade-up" delay={0}>
            <div className="relative overflow-hidden rounded-2xl group cursor-pointer">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-accent/90 via-accent/40 to-transparent flex items-end p-6 transition-all duration-300 group-hover:from-primary/90 group-hover:via-primary/40">
                <span className="text-white font-semibold text-lg">Fundações</span>
              </div>
            </div>
          </ScrollReveal>
          <ScrollReveal animation="fade-up" delay={150}>
            <div className="relative overflow-hidden rounded-2xl group cursor-pointer">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-accent/90 via-accent/40 to-transparent flex items-end p-6 transition-all duration-300 group-hover:from-primary/90 group-hover:via-primary/40">
                <span className="text-white font-semibold text-lg">Estruturas metálicas</span>
              </div>
            </div>
          </ScrollReveal>
          <ScrollReveal animation="fade-up" delay={300}>
            <div className="relative overflow-hidden rounded-2xl group cursor-pointer">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-accent/90 via-accent/40 to-transparent flex items-end p-6 transition-all duration-300 group-hover:from-primary/90 group-hover:via-primary/40">
                <span className="text-white font-semibold text-lg">Concreto armado</span>
              </div>
            </div>
          </ScrollReveal>
        </div>
        ...
        {/* Additional Service */}
        <ScrollReveal animation="fade-up">
          <div className="mt-12 bg-accent text-accent-foreground rounded-2xl p-8 md:p-12 hover-glow">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <a
                ...
                className="flex-shrink-0 bg-white text-accent font-semibold px-8 py-4 rounded-lg hover:bg-white/90 hover:scale-105 transition-all duration-300"
              >
                Solicitar orçamento
              </a>
            </div>
