    ...
    <section id="servicos" className="section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
          ...
          {galleryImages.map((image, index) => (
            <StaggerItem key={index}>
              ...
              >
                ...
                />
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-t from-accent/80 to-transparent flex items-end p-6"
                  initial={{ opacity: 0.8 }}
        ...
        <AnimatedSection className="mt-12" delay={0.3}>
          <motion.div 
            className="bg-accent text-accent-foreground rounded-2xl p-8 md:p-12"
